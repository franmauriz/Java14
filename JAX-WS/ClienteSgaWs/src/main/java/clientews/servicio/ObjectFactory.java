...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.fran.mauriz/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.fran.mauriz/", "listarPersonasResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.fran.mauriz/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.fran.mauriz/", name = "listarPersonasResponse")
