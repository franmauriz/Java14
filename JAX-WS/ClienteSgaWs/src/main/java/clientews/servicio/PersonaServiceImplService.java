 ...
 * 
 */
@WebServiceClient(name = "PersonaServiceImplService", targetNamespace = "http://servicio.fran.mauriz/", wsdlLocation = "http://localhost:8080/PersonaServiceImplService/PersonaServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONASERVICEIMPLSERVICE_QNAME = new QName("http://servicio.fran.mauriz/", "PersonaServiceImplService");
     ...
     * 
     * @return
     *     returns PersonaServiceSw
     */
    @WebEndpoint(name = "PersonaServiceImplPort")
    public PersonaServiceSw getPersonaServiceImplPort() {
        return super.getPort(new QName("http://servicio.fran.mauriz/", "PersonaServiceImplPort"), PersonaServiceSw.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonaServiceImplPort")
    public PersonaServiceSw getPersonaServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicio.fran.mauriz/", "PersonaServiceImplPort"), PersonaServiceSw.class, features);
    }
